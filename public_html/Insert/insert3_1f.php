...
<h2> Εισαγωγή 3.1στ </h2>
<p>Εισαγωγή στοιχείων παραβάσεων Oδηγού:</p>

<form align="left" action="insert3_1f.php" method="post">
	<table align="left">
...
if(isset($_POST['Submit'])){ 
	...
	if($numOfRows==0){
		// Εντολή για την εισαγωγή στην βάση(ΠΙΝΑΚΑ violation).
		$queryInsertViolation = "INSERT INTO violation(veh_id,mviolatn) VALUES ('$veh_idTemp','$mviolatnTemp')";  
		$rs1 = pg_query($con, $queryInsertViolation) or die("Cannot execute queryInsertViolation: $queryInsertViolation\n");
		echo"Επιτυχής Εισαγωγή Δεδομένων Στην Βάση(ΠΙΝΑΚΑ violation)!!!<br> 
			";
	}else{
		echo"<b>Ανεπιτυχής Εισαγωγή Δεδομένων Στην Βάση(ΠΙΝΑΚΑ violation)</b>.<br>
