...
<h2> Εισαγωγή 3.1ιδ </h2>
<p>Εισαγωγή στοιχείων μηχανισμού προστασίας μη-εποχούμενου</p>

<form align="left" action="insert3_1n.php" method="post">
	<table align="left">
...
if(isset($_POST['Submit'])){ 
	...
	if($numOfRows==0){
		// Εντολή για την εισαγωγή στην βάση(ΠΙΝΑΚΑ non_motorist_safety_equipment).
		$queryInsertNonMotorisSafetyEquipment = "INSERT INTO non_motorist_safety_equipment(per_id,msafeqmt) VALUES ('$per_idTemp','$msafeqmtTemp')";  
		$rs1 = pg_query($con, $queryInsertNonMotorisSafetyEquipment) or die("Cannot execute queryInsertNonMotorisSafetyEquipment: $queryInsertNonMotorisSafetyEquipment\n");
		echo"Επιτυχής Εισαγωγή Δεδομένων Στην Βάση(ΠΙΝΑΚΑ non_motorist_safety_equipment)!!!<br> 
			";
	}else{
		echo"<b>Ανεπιτυχής Εισαγωγή Δεδομένων Στην Βάση(ΠΙΝΑΚΑ non_motorist_safety_equipment)</b>.<br>
