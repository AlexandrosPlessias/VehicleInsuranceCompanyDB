...
<h2> Διαγραφή 3.1ιβ </h2>
<p>Διαγραφή στοιχείων ενεργειών μη-εποχούμενου την στιγμή της σύγκρουσης:</p>

<form align="left" action="delete3_1l.php" method="post">
	<table align="left">
...
if(isset($_POST['Submit'])){ 
	...
	if($numOfRows!=0){
		// Εντολή για την Διαγραφή από την βάση(ΠΙΝΑΚΑ non_motorist_crash).
		$queryDeleteNonMotoristCrash = "DELETE FROM non_motorist_crash WHERE per_id='$per_idTemp' AND mtm_crsh='$mtm_crshTemp' ";  
		$rs1 = pg_query($con, $queryDeleteNonMotoristCrash) or die("Cannot execute queryDeleteNonMotoristCrash: $queryDeleteNonMotoristCrash\n");
		echo"Επιτυχής Διαγραφή Δεδομένων απο την Βάση(ΠΙΝΑΚΑ non_motorist_crash)!!!<br> 
			";
	}else{
		echo"<b>Ανεπιτυχής Διαγραφή Δεδομένων απο την Βάση(ΠΙΝΑΚΑ non_motorist_crash)</b>.<br>
