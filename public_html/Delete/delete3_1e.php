...
<h2> Διαγραφή 3.1ε </h2>
<p>Διαγραφή στοιχείων παραγόντων Οχημάτων:</p>

<form align="left" action="delete3_1e.php" method="post">
	<table align="left">
...
if(isset($_POST['Submit'])){ 
	...
	if($numOfRows!=0){
		// Εντολή για την Διαγραφή από την βάση(ΠΙΝΑΚΑ factor).
		$queryDeleteFactor = "DELETE FROM  factor WHERE veh_id='$veh_idTemp' AND mfactor='$mfactorTemp'"; 
		$rs1 = pg_query($con, $queryDeleteFactor) or die("Cannot execute queryDeleteFactor: $queryDeleteFactor\n");
		echo"Επιτυχής Διαγραφή Δεδομένων απο την Βάση(ΠΙΝΑΚΑ factor)!!!<br> 
			";
	}else{
		echo"<b>Ανεπιτυχής Διαγραφή Δεδομένων απο την Βάση(ΠΙΝΑΚΑ factor)</b>.<br>
